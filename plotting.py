...
def plot_tsne_by_author_allowed(qdrant_client, collection_name, model_name, max_points = 1000):
...
def fetch_all_embeddings_for_tsne(qdrant_client, collection_name, model_name, max_points = 1000):
    embeddings = []
    labels = []
    scroll_filter_conditions = [
        FieldCondition(key="model_name", match=MatchValue(value=model_name))
...
def plot_tsne_of_embeddings(qdrant_client, collection_name, model_name, max_points = 1000):
    print(f"Pobieranie embeddingów do t-SNE (max {max_points})...")
...
def plot_tsne_of_authors_avg(qdrant_client, collection_name, model_name, max_points = 1000):
    """
